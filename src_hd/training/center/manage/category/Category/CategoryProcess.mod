...
' #txt
Ss0 f3 83 419 26 26 -15 15 #rect
Ss0 f3 @|UdEventIcon #fIcon
Ss0 f4 339 419 26 26 0 12 #rect
Ss0 f4 @|UdExitEndIcon #fIcon
Ss0 f5 109 432 339 432 #arcP
...
Ss0 f8 guid 178CA20BF6994E6D #txt
...
' #txt
Ss0 f16 83 339 26 26 -18 15 #rect
...
' #txt
Ss0 f21 168 330 112 44 0 -8 #rect
Ss0 f21 @|StepIcon #fIcon
Ss0 f22 109 352 168 352 #arcP
Ss0 f20 280 352 339 352 #arcP
Ss0 f13 guid 178CAA40D48F6CC0 #txt
Ss0 f13 method update(ch.ivyteam.ivy.workflow.category.Category) #txt
Ss0 f13 inParameterDecl '<ch.ivyteam.ivy.workflow.category.Category category> param;' #txt
...
Ss0 f16 mainOut f22 tail #connect
